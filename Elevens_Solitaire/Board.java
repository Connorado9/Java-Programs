...
public abstract class Board
{
    ...
    /**
     * Accesses how many cards remain undealt.
     *
     * @return the number of undealt cards left in the deck.
     */
    public int getNumUndealt()
    {
        return deck.getNumUndealt();
    }
     ...
     *
     * @param selectedCards is the ArrayList of the indexes of the cards
     * to be replaced.
     */
     ...
     *
     * @return an ArrayList that contains the locations (indexes) of the
     * non-null entries on the board.
     */
